...
import { getData,popUploadedVideo,deletePopVideo,GetDataById,updateVdieo ,VideoLimit} from "../controllers/aggregationAndPopulate.js";
...
router.route("/aggragate").get(VideoLimit)
